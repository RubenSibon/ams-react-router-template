...
import { CameraIcon, ClockIcon, FacebookIcon, LinkedinIcon, MailIcon, PhoneIcon, XIcon } from "@amsterdam/design-system-react-icons";
          ...
          <Grid.Cell span={4}>
            ...
            <LinkList>
              {["Veel gestelde vragen", "Over ons", "Werken bij", "Kalender", "Uit in Amsterdam", "Bronnen"].map(
                (label, index) => (
                  <LinkList.Link key={index} color="inverse" href="#" size="small">
                    {label}
                  </LinkList.Link>
                ),
              )}
            ...
            <div>
              ...
              <LinkList>
                {socialPlatforms.map(({ icon, name }) => (
                  <LinkList.Link key={name} color="inverse" href="#" icon={icon} size="small">
                    {name}
                  </LinkList.Link>
                ))}
              </LinkList>
